...
function Notification(options = {}) {
    ...
    const dialogButtons = (okText = 'OK', cancelText = 'Cancel') => {
        return `<div class="notification-buttons">
    <span class="notification-button notification-action">${okText}</span>
    <span class="notification-button notification-cancel">${cancelText}</span>
  </div>`;
    };
